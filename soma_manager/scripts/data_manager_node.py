...
if __name__=="__main__":
    ...
    parser.add_argument("--db_name", nargs='?', help='Name of the mongo database' , default="somadata")
    ...
    rospy.loginfo("Running SOMA Data Manager (object db: %s, object_collection: %s, roi_collection: %s)", args.db_name, args.object_collection_name,args.roi_collection_name)
    SOMADataManager(args.db_name,args.object_collection_name,args.roi_collection_name)
